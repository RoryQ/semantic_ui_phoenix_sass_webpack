...
# SemanticUiPhoenixSassWebpackWeb.Endpoint.init/2 when load_from_system_env is
...
# start per endpoint:
#
#     config :semantic_ui_phoenix_sass_webpack, SemanticUiPhoenixSassWebpackWeb.Endpoint, server: true
#
